...
Include response hand as a covariate, for the analyses:
- Exp 1, 2, and 1+2: FxLxH (categorical) on RT
- Exp 3: FxLxH with dichotic listening as a covariate

Add analysis including task order as a covariate, for the key tests: 
- Exp 2: FxLxH (categorical) on RT
- Exp 3: the effect of handedness on dichotic listening laterality
- Exp 3: FxLxH with dichotic listening as a covariate
